...
function select(yearValue) {
  ...
  function bubbleChart() {
    ...
    function chart(selection) {
      ...
      var div = selection,
          svgBubble = div.select("#bubbleArea");
      svgBubble.attr('width', width).attr('height', height);
      ...
      d3.select("svg > #chart").exit().remove();
      ...
      var node = svgBubble.selectAll("circle")
        ...
        .on("mouseover", function(d) {
          if (moving == false) {
            console.log(yearTemp + " mouseover");
